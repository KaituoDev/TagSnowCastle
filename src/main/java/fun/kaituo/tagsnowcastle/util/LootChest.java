...
public class LootChest {
    ...
    public void enable() {
        ...
        taskIds.add(Bukkit.getScheduler().scheduleSyncRepeatingTask(TagSnowCastle.inst(), this::updateColor, 1, 1));

        taskIds.add(Bukkit.getScheduler().scheduleSyncRepeatingTask(TagSnowCastle.inst(), () -> {
